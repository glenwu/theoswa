...
//
// ⚠️ 底牌里的主牌【不挡】—— 这是规则裁定，不要"修正"成挡。
// 规则文档 §6.8.2b 在这一点上自相矛盾：正面表述说「必须已打出/在你手上/埋底时被公开亮出」
// （主牌埋底并不公开，照此则应该挡），反面表述说「没有比 c 大的主牌还留在其他三家的暗牌里」
// （底牌不是任何人的手牌，照此则不挡）。
// 已向规则作者确认，以后者为准：底牌里的牌这一局不可能再出现在牌面上，压不到你，所以不挡。
// 代价是只有庄家知道底牌内容、闲家算不准 —— 但 §6.8.2b 本就规定主牌甩牌不给提示、
// 由玩家心算、算错了服务端收缩为最小一张，服务端偏宽松对玩家有利，是可接受的。
