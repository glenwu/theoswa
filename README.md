...
- **三主过河**：主牌 ≤3 张的人可把全部主牌交给对家换回 3 张副牌（每队每局一次，先点先得；庄家【自己发起】过河后若被撬底，底牌每张主牌让闲家额外 +1 级；队友发起、把主牌交给庄家的那一笔不算，庄家把这几张主埋进底也不受罚）。分两轮开窗：**发牌完、埋底前**那一轮只开给庄家的队友（他要给的是庄家，得让庄家拿着最终的手牌去埋底）；**换底后、出牌前**那一轮开给其余人（庄家自己发起、闲家之间）。名额和「已跳过」跨两轮继承 —— 每队一局仍然只有一次。
