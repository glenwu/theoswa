...
runMutants([
  [F, 'return highCards(withoutJokers.length ? withoutJokers : trumps, 1, ctx)[0];',
      'return lowestLead(withoutJokers.length ? withoutJokers : trumps, ctx);', '强势主改吊小牌'],
  [F, 'if (!canSustainTrumpDraw(trumps, ctx, control)) {', 'if (true) {', '一律当弱势主吊小牌'],
  [F, 'if (!canSustainTrumpDraw(trumps, ctx, control)) {', 'if (false) {', '一律当强势主'],
